  ...
  return (
    <div className='toolsre'>
        ...
        <div className='toolssearchbox'>
          ...
          <div>
            <button className='addnewbuttontools' onClick={() => setShowForm(true)} style={{position:''}}>Add New</button>
            <button className="editbuttontools"onClick={()=>setEnableEdit(preve => !preve)}>Edit</button>
          </div>
        
    <div>
      {/* add new */}
      {showForm && (
      <div className='popup-container toolspopup'  onClick={(e)=>{
        e.stopPropagation()
        setShowForm(false)
      }} > 
