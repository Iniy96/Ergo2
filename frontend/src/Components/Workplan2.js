      ...
      <div className="col col-lg-6 mx-auto d-flex justify-content-center" style={{ marginTop: '33px' }}>
          ...
          <table className="table table-responsive table-bordered mx-auto">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="table-light">{projectList[0]?.Customer_Name} </td>
              </tr>
              <tr>
			  ...
			  <tr>
				...
				<tr>
					...
					<td>{projectList[0]?.Supervisor1}</td>
				</tr>
				<tr>
					<th className="table-light"scope="row">Mobilisation Details</th>
					<td className="table-light" >{projectList[0]?.Estimated_Date_Of_Commencement} </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td className="table-light">1. Daily Report &amp; Final Report
		2. Status Sheet
		3. Feedback form</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td className="table-light">1. Daily Report to be sent to central team every evening
		2. Final report to be prepared .
		3. Parts list to be made.</td>
				</tr>
				<tr>
					<th className="table-light" scope="row">Contact Point</th>
					<td className="table-light">1st Contact: Operation Team (projects@ergontec.com, +971527256908) 2nd Contact: Technical Team (operation@ergontec.com, +971521988815) 3rd Contact: Mathew (mbm@ergontec.com, +971585039099)</td>
				</tr>
				<tr>
					<th className="table-light"scope="row">Essential Documents Checklist</th>
					<td className="table-light">1. Passport
		2. BOSIET
		...
		6. Entry Permit for {projectList[0]?.Rig_Location}</td>
				...
				<tr>
					...
					<td className="table-light">1. Please ensure that the Ergon Reporting formats are followed for the task.
		2. Please ensure that all mandatory HSE documents are filled in correctly and returned after the completion of the job
		3. Please ensure that daily progress reports are sent into the central team on a regular basis
		4. Please ensure that all DPR’s and timesheets are signed and stamped by the
		client on completion of the task.
		5. In case of any variation in the Scope of Work defined above, please inform the central team.</td>
          ...
          <div>
        <h6 className="table-light" style={{ marginLeft: '400px', marginTop: '10px' }}>Prepared By</h6>
        <h6 className="table-light" style={{ marginLeft: '800px', marginTop: '-30px' }}>Signed By</h6>
      </div>
      <div>
        <h6 className="table-light" style={{ marginLeft: '400px', marginTop: '30px' }}>Shubham Mehata</h6>
        <h6></h6>
      </div>
      <div className="">
        <div className="table-light" style={{ textAlign: 'left', marginTop: '70px' }}>TSD-OPS-FOR-009-19, Rev.01</div>
        <div className="table-light" style={{ textAlign: 'center', marginTop: '-20px' }}>30 April 2022</div>
        <div className="table-light" style={{ textAlign: 'right', marginTop: '-30px' }}>6</div>
      </div> 
        </form>
      </div>
